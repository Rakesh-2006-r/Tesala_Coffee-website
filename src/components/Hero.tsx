  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 flex justify-center items-center opacity-30 mt-20">
        <div className="w-[60vw] h-[60vw] max-w-[600px] max-h-[600px] bg-red-900 rounded-full blur-[120px] mix-blend-screen" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 mt-16">
        ...
        >
          0-100% energy. Engineered for the first sip.
        </motion.p>
        ...
        >
          <a href="#order" className="w-full sm:w-64 py-3 bg-red-600 hover:bg-red-700 text-white font-medium tracking-widest text-sm rounded transition-colors text-center uppercase">
            Order Model C
          </a>
